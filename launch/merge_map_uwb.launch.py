...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("rendezvous_auto_enabled", default_value="false"),
        ...
        DeclareLaunchArgument("rendezvous_manual_topic", default_value="/rendezvous_now"),
        ...
        ExecuteProcess(
            cmd=[
                ...
                "-p", ["rendezvous_auto_enabled:=", LaunchConfiguration("rendezvous_auto_enabled")],
                ...
                "-p", ["rendezvous_manual_topic:=", LaunchConfiguration("rendezvous_manual_topic")],
            ],
            output="screen",
        ),
    ])
